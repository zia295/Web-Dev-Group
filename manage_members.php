...
<body>
    ...
    <?php if (isset($_GET['action']) && $_GET['action'] === 'edit') : ?>
        <?php if (isset($_SESSION['user'])) : ?>
            <h2>Edit User</h2>
            <form class="form-container" method="post" action="update_user.php">
                <input type="hidden" name="id" value="<?php echo $_SESSION['user']['user_id']; ?>">
                <label for="nickname">Nickname:</label>
                <input type="text" name="nickname" id="nickname" value="<?php echo $_SESSION['user']['user_nickname']; ?>">
                <label for="name">Name:</label>
                <input type="text" name="name" id="name" value="<?php echo $_SESSION['user']['user_name']; ?>">
                <label for="email">Email:</label>
                <input type="email" name="email" id="email" value="<?php echo $_SESSION['user']['user_email']; ?>">
